...
// 载入背景图
$imgLeft = imagecreatefrompng('./images/left.png');
$imgCenter = imagecreatefrompng('./images/center.png');
$imgRight = imagecreatefrompng('./images/right.png');
// 计算位置信息
$paddingLeft = 6;
$paddingRight = 3;
...
imagecopy($img, $imgCenter, $widthLeft, 0, 0, 0, $widthCenter, $height);
